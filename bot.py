...
def runBot():
  ...
  def start(bot, update):
    ...
    username = user
    print("\nNew user clicked on start button\nUser ID: "+format(username.id)+"\nUsername: "+format(username.username)+"\nFirst Name: "+format(username.first_name)+"\nLast Name: "+format(username.last_name))
    update.message.reply_text(greeting(username),
                              reply_markup=main_menu_keyboard(),
                              parse_mode='Markdown')
    
  def greeting(user_name):
    return '*Hello, '+format(username.first_name)+" "+format(username.last_name)+'! *'+'\n\nWelcome to *Tech-News Bot*.\n'
  ...
  def main_menu(bot, update):
    #print("\nSomeone clicked on start button\nUser ID: "+format(username.id)+"\nUsername: "+format(username.username)+"\nFirst Name: "+format(username.first_name)+"\nLast Name: "+format(username.last_name))
  ...
  def main_menu_message():
      return 'Hello, this is *Tech-News Bot*.\n\n'
  ...
  def first_menu_message():
    return u'\U0001F449 '+' Select a source: '
  ...
  def submenu_button(u1,u2):
    keyboard = [[InlineKeyboardButton('Back', callback_data=u1),InlineKeyboardButton('Next', callback_data=u2)],
                [InlineKeyboardButton('News Sources', callback_data='m1')]]
    return InlineKeyboardMarkup(keyboard)
  ...
  def first_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm1_1"),
                          parse_mode="Markdown")
  ...
  def second_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm2_1"),
                          parse_mode="Markdown")
  ...
  def third_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm3_1"),
                          parse_mode="Markdown")
  ...
  def fourth_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm4_1"),
                          parse_mode="Markdown")
  ...
  def fifth_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm5_1"),
                          parse_mode="Markdown")
  ...
  def sixth_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm6_1"),
                          parse_mode="Markdown")
  ...
  def seventh_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm7_1"),
                          parse_mode="Markdown")
  ...
  def eights_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm8_1"),
                          parse_mode="Markdown")
  ...
  def nineth_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm9_1"),
                          parse_mode="Markdown")
  ...
  def tenth_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm10_1"),
                          parse_mode="Markdown")
  ...
  def eleventh_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm11_1"),
                          parse_mode="Markdown")
  ...
  def twelveth_submenu(bot, update):
    ...
    bot.edit_message_text(chat_id=query.message.chat_id,
                          ...
                          reply_markup = submenu_button("m1","sm12_1"),
                          parse_mode="Markdown")
  ...
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu01, pattern='^sm1_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu02, pattern='^sm1_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu03, pattern='^sm1_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu04, pattern='^sm1_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu05, pattern='^sm1_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu06, pattern='^sm1_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu07, pattern='^sm1_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu08, pattern='^sm1_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(first_submenu09, pattern='^sm1_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu, pattern='^m1_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu01, pattern='^sm2_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu02, pattern='^sm2_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu03, pattern='^sm2_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu04, pattern='^sm2_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu05, pattern='^sm2_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu06, pattern='^sm2_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu07, pattern='^sm2_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu08, pattern='^sm2_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(second_submenu09, pattern='^sm2_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu, pattern='^m1_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu01, pattern='^sm3_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu02, pattern='^sm3_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu03, pattern='^sm3_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu04, pattern='^sm3_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu05, pattern='^sm3_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu06, pattern='^sm3_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu07, pattern='^sm3_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu08, pattern='^sm3_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(third_submenu09, pattern='^sm3_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu, pattern='^m1_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu01, pattern='^sm4_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu02, pattern='^sm4_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu03, pattern='^sm4_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu04, pattern='^sm4_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu05, pattern='^sm4_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu06, pattern='^sm4_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu07, pattern='^sm4_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu08, pattern='^sm4_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fourth_submenu09, pattern='^sm4_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu, pattern='^m1_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu01, pattern='^sm5_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu02, pattern='^sm5_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu03, pattern='^sm5_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu04, pattern='^sm5_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu05, pattern='^sm5_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu06, pattern='^sm5_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu07, pattern='^sm5_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu08, pattern='^sm5_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(fifth_submenu09, pattern='^sm5_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu, pattern='^m1_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu01, pattern='^sm6_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu02, pattern='^sm6_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu03, pattern='^sm6_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu04, pattern='^sm6_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu05, pattern='^sm6_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu06, pattern='^sm6_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu07, pattern='^sm6_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu08, pattern='^sm6_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(sixth_submenu09, pattern='^sm6_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu, pattern='^m1_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu01, pattern='^sm7_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu02, pattern='^sm7_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu03, pattern='^sm7_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu04, pattern='^sm7_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu05, pattern='^sm7_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu06, pattern='^sm7_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu07, pattern='^sm7_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu08, pattern='^sm7_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(seventh_submenu09, pattern='^sm7_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu, pattern='^m1_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu01, pattern='^sm8_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu02, pattern='^sm8_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu03, pattern='^sm8_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu04, pattern='^sm8_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu05, pattern='^sm8_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu06, pattern='^sm8_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu07, pattern='^sm8_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu08, pattern='^sm8_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eights_submenu09, pattern='^sm8_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu, pattern='^m1_9$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu01, pattern='^sm9_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu02, pattern='^sm9_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu03, pattern='^sm9_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu04, pattern='^sm9_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu05, pattern='^sm9_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu06, pattern='^sm9_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu07, pattern='^sm9_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu08, pattern='^sm9_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(nineth_submenu09, pattern='^sm9_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu, pattern='^m1_10$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu01, pattern='^sm10_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu02, pattern='^sm10_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu03, pattern='^sm10_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu04, pattern='^sm10_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu05, pattern='^sm10_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu06, pattern='^sm10_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu07, pattern='^sm10_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu08, pattern='^sm10_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(tenth_submenu09, pattern='^sm10_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu, pattern='^m1_11$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu01, pattern='^sm11_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu02, pattern='^sm11_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu03, pattern='^sm11_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu04, pattern='^sm11_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu05, pattern='^sm11_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu06, pattern='^sm11_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu07, pattern='^sm11_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu08, pattern='^sm11_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(eleventh_submenu09, pattern='^sm11_9$'))

  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu, pattern='^m1_12$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu01, pattern='^sm12_1$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu02, pattern='^sm12_2$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu03, pattern='^sm12_3$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu04, pattern='^sm12_4$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu05, pattern='^sm12_5$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu06, pattern='^sm12_6$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu07, pattern='^sm12_7$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu08, pattern='^sm12_8$'))
  updater.dispatcher.add_handler(CallbackQueryHandler(twelveth_submenu09, pattern='^sm12_9$'))
...
def scrape():
 ...
 "techcrunch.com":
  ...
  """,
      "gigaom.com":
          {"rss": "https://voicesinai.com/show/voices-in-ai/podcast-feed/",
